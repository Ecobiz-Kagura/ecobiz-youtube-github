...
# BGMファイルのパス
$BgmPath = "D:\ecobiz-youtube-uploader\google-trans\MP3s\dark-fall.mp3"
...
ffmpeg -hide_banner `
  ...
  -filter_complex "[1:a]volume=0.4[bgm];[0:a]volume=1[v0];[v0][bgm]amix=inputs=2:duration=first:dropout_transition=2:normalize=1[aout]" `
  -map 0:v:0 -map "[aout]" `
